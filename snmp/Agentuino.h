...
#define SNMP_DEFAULT_PORT       5700
#define SNMP_DEFAULT_REMOTE_PORT  161
...
public:
 ...
 /*
		SNMP_API_STAT_CODES responsePdu(IPAddress targetIp,SNMP_PDU *pdu);
		
		SNMP_API_STAT_CODES getPdu(IPAddress targetIp,SNMP_PDU *pdu);
        
		SNMP_API_STAT_CODES setPdu(IPAddress targetIp, SNMP_PDU *pdu);
		*/
 
        SNMP_API_STAT_CODES responsePdu(byte *targetIp,SNMP_PDU *pdu);
		
		SNMP_API_STAT_CODES getPdu(byte *targetIp,SNMP_PDU *pdu);
        
		SNMP_API_STAT_CODES setPdu(byte *targetIp, SNMP_PDU *pdu);
		...
		SNMP_API_STAT_CODES oidbasteln(int oidlength,char *sysDescr,SNMP_PDU *pdu);
		
		SNMP_API_STAT_CODES sendgetpacket(SNMP_PDU *pdu);
		SNMP_API_STAT_CODES sendsetpacket(SNMP_PDU *pdu);
